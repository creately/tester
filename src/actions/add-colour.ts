...
export default class AddColour implements Action {
  async execute(args: any[], context: any): Promise<string[]> {
    ...
    await driver.findElement(By.xpath('//*[@id="contextual-toolbar"]/div/toolbar-shape-style-dropdown/div/abs-dropdown/div/div[2]/div/ul/perfect-scrollbar/div/div[1]/div/div[2]/div[1]')).click();
