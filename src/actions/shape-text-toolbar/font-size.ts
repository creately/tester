...
export default class FontSize implements Action {
    async execute(args: any[], context: any): Promise<string[]> {
        ...
        if (await dropDownList.isDisplayed()) {
            const fontSize = await driver.findElement(By.xpath('//*[@id="shape-text-toolbar"]/div/toolbar-input-list-dropdown/div/abs-dropdown/div/div[2]/div/ul/perfect-scrollbar/div/div[1]/toolbar-list-dropdown-item[' + args[0] + ']'));
