...
<<<<<<< HEAD
    async execute(args: any[], context: any): Promise<string[]> {
        ...
        const colourCodeList = await driver.findElement(By.xpath('//*[@id="shape-text-toolbar"]/div/toolbar-grid-dropdown/abs-dropdown/div/div[2]/div/ul'));
        if (await colourCodeList.isDisplayed()) {
            const colourCode = await driver.findElement(By.xpath('//*[@id="shape-text-toolbar"]/div/toolbar-grid-dropdown/abs-dropdown/div/div[2]/div/ul/perfect-scrollbar/div/div[1]/toolbar-grid-dropdown-item[' + args[0] + ']'));
