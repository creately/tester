...
/* 
  *  Apply colured dashed lines for shapes or lines
  *  arags[0] refers the colour code index 
*/
export default class AddColourDashedLine implements Action {
    async execute(args: any[], context: any): Promise<string[]> {
        var driver: WebDriver = context.driver;
        await driver.findElement(By.xpath('//*[@id="contextual-toolbar"]/div/toolbar-shape-style-dropdown/div/abs-dropdown/div/div[2]/div/ul/perfect-scrollbar/div/div[1]/div/div[2]/div[3]')).click();
